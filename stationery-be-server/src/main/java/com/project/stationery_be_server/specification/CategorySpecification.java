...
public class CategorySpecification {
    public static Specification<Category> filterCategory(String  search) {
        return (root, query, criteriaBuilder) -> {
            ...
            if (search != null && !search.trim().isEmpty()) {
                ...
                Predicate byName = criteriaBuilder.like(criteriaBuilder.lower(root.get("categoryName")), keyword);
